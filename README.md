...
<p align="center">
  <img src="App/Resources/Assets.xcassets/AppIcon.appiconset/Icon-512@2x.png" width="128" alt="Shuo logo">
</p>
...
- Managed local Whisper and SenseVoice models, optional cloud transcription,
  and optional cloud text features
...
- 受管理的本地 Whisper 与 SenseVoice 模型；可选云端转写与云端文本功能
