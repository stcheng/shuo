...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel><item><sparkle:version>7</sparkle:version><sparkle:shortVersionString>0.1.0</sparkle:shortVersionString><enclosure url="${download_prefix}Shuo-0.1.0-macOS.zip" length="$archive_length" sparkle:edSignature="test" /></item></channel>
</rss>
XML
EOF
